...
function MapSection() {
  ...
  const MAP_POINTS = [
    // ปกติ (green)
    { lng: 100.5018, lat: 13.7563, status: 'normal', name: 'นายวิชัย ทดสอบ5', vital: 'BP 120/80 mmHg', vtype: 'ความดันโลหิต', age: 45, gender: 'ชาย' },
    { lng: 98.9853, lat: 18.7883, status: 'normal', name: 'นางบุญมา ทดสอบ4', vital: 'อุณหภูมิ 36.5 °C', vtype: 'อุณหภูมิ', age: 58, gender: 'หญิง' },
    { lng: 100.4733, lat: 7.0086, status: 'normal', name: 'นางจันทร์เพ็ญ ทดสอบ7', vital: 'BP 118/75 mmHg', vtype: 'ความดันโลหิต', age: 32, gender: 'หญิง' },
    { lng: 102.8360, lat: 16.4322, status: 'normal', name: 'นายสมศักดิ์ ทดสอบ8', vital: 'ชีพจร 72 bpm', vtype: 'ชีพจร', age: 68, gender: 'ชาย' },
    { lng: 100.9925, lat: 12.9236, status: 'normal', name: 'นายอำนวย ทดสอบ10', vital: 'SpO2 98%', vtype: 'ออกซิเจน', age: 62, gender: 'ชาย' },
    { lng: 99.0087, lat: 18.5590, status: 'normal', name: 'นางปราณี ทดสอบ9', vital: 'น้ำตาล 95 mg/dL', vtype: 'น้ำตาล', age: 75, gender: 'หญิง' },
    { lng: 100.5166, lat: 13.6513, status: 'normal', name: 'นางสุนีย์ ทดสอบ6', vital: 'BP 125/82 mmHg', vtype: 'ความดันโลหิต', age: 70, gender: 'หญิง' },
    // ผิดปกติ (red)
    { lng: 100.5382, lat: 13.7248, status: 'abnormal', name: 'นายสมชาย ทดสอบ', vital: 'BP 150/92 mmHg', vtype: 'ความดันโลหิต', badge: 'ความดันสูง', age: 72, gender: 'ชาย' },
    { lng: 100.4394, lat: 13.7200, status: 'abnormal', name: 'นางสมศรี ทดสอบ2', vital: 'SpO2 80%', vtype: 'ออกซิเจน', badge: 'ออกซิเจนต่ำ', age: 65, gender: 'หญิง' },
    { lng: 104.1348, lat: 17.1533, status: 'abnormal', name: 'นายประยูร ทดสอบ3', vital: 'อุณหภูมิ 38.5 °C', vtype: 'อุณหภูมิ', badge: 'มีไข้สูง', age: 80, gender: 'ชาย' },
    { lng: 100.5652, lat: 13.6800, status: 'abnormal', name: 'นางบุญมา ทดสอบ4', vital: 'ชีพจร 110 bpm', vtype: 'ชีพจร', badge: 'หัวใจเต้นเร็ว', age: 58, gender: 'หญิง' },
    { lng: 102.1044, lat: 14.9666, status: 'abnormal', name: 'นายวิชัย ทดสอบ5', vital: 'น้ำตาล 280 mg/dL', vtype: 'น้ำตาล', badge: 'น้ำตาลสูงมาก', age: 45, gender: 'ชาย' },
    { lng: 99.8266, lat: 19.9105, status: 'abnormal', name: 'นางสุนีย์ ทดสอบ6', vital: 'BP 165/100 mmHg', vtype: 'ความดันโลหิต', badge: 'ความดันวิกฤต', age: 70, gender: 'หญิง' },
    { lng: 99.0956, lat: 9.1382, status: 'abnormal', name: 'นางจันทร์เพ็ญ ทดสอบ7', vital: 'อุณหภูมิ 39.2 °C', vtype: 'อุณหภูมิ', badge: 'ไข้สูงมาก', age: 32, gender: 'หญิง' },
    { lng: 100.0800, lat: 9.9608, status: 'abnormal', name: 'นายสมศักดิ์ ทดสอบ8', vital: 'SpO2 85%', vtype: 'ออกซิเจน', badge: 'ออกซิเจนต่ำ', age: 68, gender: 'ชาย' },
    { lng: 98.3923, lat: 7.8804, status: 'abnormal', name: 'นางปราณี ทดสอบ9', vital: 'ชีพจร 120 bpm', vtype: 'ชีพจร', badge: 'หัวใจเต้นเร็วมาก', age: 75, gender: 'หญิง' },
    { lng: 101.1453, lat: 12.6817, status: 'abnormal', name: 'นายอำนวย ทดสอบ10', vital: 'น้ำตาล 320 mg/dL', vtype: 'น้ำตาล', badge: 'น้ำตาลวิกฤต', age: 62, gender: 'ชาย' },
    { lng: 103.5038, lat: 15.2500, status: 'abnormal', name: 'นายสมชาย ทดสอบ', vital: 'BP 180/110 mmHg', vtype: 'ความดันโลหิต', badge: 'ความดันวิกฤต', age: 72, gender: 'ชาย' },
  ];

  const abnormalPatients = [
    { name: 'สมชาย ทดสอบ', type: 'ความดันโลหิต', reading: '150/77 mmHg', badge: 'ความดันโลหิตสูง', age: 72, gender: 'ชาย' },
    { name: 'สมศรี ทดสอบ2', type: 'ออกซิเจน', reading: '80%', badge: 'ต่ำ', age: 65, gender: 'หญิง' },
    { name: 'ประยูร ทดสอบ3', type: 'อุณหภูมิ', reading: '38.00 °C', badge: 'มีไข้', age: 80, gender: 'ชาย' },
    { name: 'บุญมา ทดสอบ4', type: 'ชีพจร', reading: '103 bpm', badge: 'หัวใจเต้นเร็ว', age: 58, gender: 'หญิง' },
    { name: 'สุนีย์ ทดสอบ6', type: 'น้ำตาล', reading: '220 mg/dL', badge: 'ระดับน้ำตาลสูงมาก', age: 70, gender: 'หญิง' },
    { name: 'จันทร์เพ็ญ ทดสอบ7', type: 'น้ำตาล', reading: '220 mg/dL', badge: 'ระดับน้ำตาลสูงมาก', age: 32, gender: 'หญิง' },
    { name: 'สมศักดิ์ ทดสอบ8', type: 'น้ำตาล', reading: '220 mg/dL', badge: 'ระดับน้ำตาลสูงมาก', age: 68, gender: 'ชาย' },
    { name: 'ปราณี ทดสอบ9', type: 'อุณหภูมิ', reading: '38.00 °C', badge: 'มีไข้', age: 75, gender: 'หญิง' },
    { name: 'อำนวย ทดสอบ10', type: 'อุณหภูมิ', reading: '38.00 °C', badge: 'มีไข้', age: 62, gender: 'ชาย' },
    { name: 'วิชัย ทดสอบ5', type: 'ความดันโลหิต', reading: '150/77 mmHg', badge: 'ความดันโลหิตสูง', age: 45, gender: 'ชาย' },
  ];
