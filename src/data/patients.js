...
export const PATIENTS = [
  { hn: 'HN001234', name: 'นายสมชาย ทดสอบ', age: 72, gender: 'ชาย', phone: '081-234-5678', address: '99/1 หมู่ 5 ต.ในเมือง อ.เมือง จ.เชียงใหม่ 50000', group: 'NCD', disease: 'DM, HT', team: 'ทีม A', adl: 55, visits: 4, lastVisit: '2026-03-28', outcome: 'ดีขึ้น' },
  { hn: 'HN001235', name: 'นางสมศรี ทดสอบ2', age: 65, gender: 'หญิง', phone: '082-345-6789', address: '123/4 หมู่ 3 ต.หนองไผ่ อ.เมือง จ.เชียงใหม่ 50000', group: 'LTC', disease: 'Stroke', team: 'ทีม B', adl: 35, visits: 6, lastVisit: '2026-03-27', outcome: 'คงที่' },
  { hn: 'HN001236', name: 'นายประยูร ทดสอบ3', age: 80, gender: 'ชาย', phone: '083-456-7890', address: '456/7 หมู่ 2 ต.บ้านนา อ.เมือง จ.เชียงใหม่ 50000', group: 'Palliative', disease: 'Ca Lung', team: 'ทีม A', adl: 20, visits: 8, lastVisit: '2026-03-26', outcome: 'แย่ลง' },
  { hn: 'HN001237', name: 'นางบุญมา ทดสอบ4', age: 58, gender: 'หญิง', phone: '084-567-8901', address: '321/5 หมู่ 8 ต.ท่าศาลา อ.เมือง จ.เชียงใหม่ 50000', group: 'NCD', disease: 'DM', team: 'ทีม C', adl: 70, visits: 3, lastVisit: '2026-03-28', outcome: 'ดีขึ้น' },
  { hn: 'HN001238', name: 'นายวิชัย ทดสอบ5', age: 45, gender: 'ชาย', phone: '085-678-9012', address: '654/9 หมู่ 1 ต.หนองนค อ.เมือง จ.เชียงใหม่ 50000', group: 'Intermediate', disease: 'Fracture Hip', team: 'ทีม B', adl: 45, visits: 5, lastVisit: '2026-03-25', outcome: 'ดีขึ้น' },
  { hn: 'HN001239', name: 'นางสุนีย์ ทดสอบ6', age: 70, gender: 'หญิง', phone: '086-789-0123', address: '987/2 หมู่ 4 ต.บายบา อ.เมือง จ.เชียงใหม่ 50000', group: 'LTC', disease: 'HT, CKD', team: 'ทีม A', adl: 40, visits: 4, lastVisit: '2026-03-27', outcome: 'คงที่' },
  { hn: 'HN001240', name: 'นางจันทร์เพ็ญ ทดสอบ7', age: 32, gender: 'หญิง', phone: '087-890-1234', address: '147/6 หมู่ 7 ต.ในเมือง อ.เมือง จ.เชียงใหม่ 50000', group: 'หญิงตั้งครรภ์', disease: 'ANC', team: 'ทีม C', adl: 95, visits: 2, lastVisit: '2026-03-28', outcome: 'ดีขึ้น' },
  { hn: 'HN001241', name: 'นายสมศักดิ์ ทดสอบ8', age: 68, gender: 'ชาย', phone: '088-901-2345', address: '258/3 หมู่ 6 ต.หนองไผ่ อ.เมือง จ.เชียงใหม่ 50000', group: 'NCD', disease: 'DM, HT', team: 'ทีม B', adl: 60, visits: 3, lastVisit: '2026-03-26', outcome: 'ดีขึ้น' },
  { hn: 'HN001242', name: 'นางปราณี ทดสอบ9', age: 75, gender: 'หญิง', phone: '089-012-3456', address: '369/8 หมู่ 9 ต.บ้านนา อ.เมือง จ.เชียงใหม่ 50000', group: 'Palliative', disease: 'Ca Breast', team: 'ทีม A', adl: 25, visits: 7, lastVisit: '2026-03-25', outcome: 'แย่ลง' },
  { hn: 'HN001243', name: 'นายอำนวย ทดสอบ10', age: 62, gender: 'ชาย', phone: '090-123-4567', address: '741/1 หมู่ 10 ต.ท่าศาลา อ.เมือง จ.เชียงใหม่ 50000', group: 'Intermediate', disease: 'Stroke', team: 'ทีม C', adl: 50, visits: 5, lastVisit: '2026-03-27', outcome: 'คงที่' },
];
